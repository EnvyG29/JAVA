...
public class MainClassFromLessonFour {
    ...
    private static void ex1() {
        ...
        while (true) {
            ...
            if (inputString.trim().length() == 0) { // trim удаляет начальные и конечные пробельные символы. if (inputString.isBlank())isBlank вернет true если строка пустая или содержит только пробельные символы
